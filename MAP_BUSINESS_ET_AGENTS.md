...
| **35** | **Chasseur de Viral** | Un seul but : trouver, dans **chaque domaine**, le produit à **potentiel viral/explosif** (le 1-sur-1000 qui peut percer), pas seulement « ce qui se vend ». Propose un candidat → approuvé ou non par Hugo → en cherche aussitôt un autre, en boucle. Distinct du Scout Marché (ratisse large) et du Stratège (décide) : lui ne vit que pour le **hit**. « elle meurt si elle ne trouve pas de trucs viraux » — Hugo 20/05. | à coder |
